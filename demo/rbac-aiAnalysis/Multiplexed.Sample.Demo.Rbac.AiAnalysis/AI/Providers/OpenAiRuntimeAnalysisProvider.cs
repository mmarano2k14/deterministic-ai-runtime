...
namespace Multiplexed.Sample.Demo.Rbac.AiAnalysis.AI.Providers
{
    public sealed class OpenAiRuntimeAnalysisProvider : IAiRuntimeAnalysisProvider
    {
        ...
        private readonly RuntimeAnalysisScenarioProposalPreflightValidator
            _proposalPreflightValidator;
            ...
            IAiPolicyRegistry policyRegistry)
        {
            ...
            _proposalPreflightValidator =
                new RuntimeAnalysisScenarioProposalPreflightValidator(
                    policyRegistry);
            _realtimeEvents =
                realtimeEvents
                ?? throw new ArgumentNullException(
            ...
            CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                await _proposalPreflightValidator.ValidateAsync(
