...
using Multiplexed.Sample.Demo.Rbac.AiAnalysis.AI.Steps;
using Multiplexed.Sample.Demo.Rbac.AiAnalysis.AI.Services;
using Multiplexed.Sample.Demo.Rbac.AiAnalysis.Auth;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Multiplexed.Sample.Demo.Rbac.AiAnalysis",
        Version = "v1",
...
builder.Services.AddSingleton<Multiplexed.Sample.Demo.Rbac.AiAnalysis.Context.DemoSeedState>();
...
{
    var endpointConfig = new EndpointConfiguration("Multiplexed.Sample.Demo.Rbac.AiAnalysis");
...
using (var scope = app.Services.CreateScope())
{
    ...
    var demo = scope.ServiceProvider.GetRequiredService<Multiplexed.Sample.Demo.Rbac.AiAnalysis.Context.DemoSeedState>();

    //var ctx = Multiplexed.Sample.Demo.Rbac.AiAnalysis.Context.ContextFactory.Full("demo-user-1");
