...
namespace Multiplexed.AI.McpServer.Tools
{
    ...
    public sealed class PublicSdkMcpTools
    {
        ...
        [McpServerTool(Name = "sdk.publish_pipeline")]
        ...
        [McpServerTool(Name = "sdk.execution.submit")]
        ...
        [McpServerTool(Name = "sdk.execution.observe")]
        ...
        [McpServerTool(Name = "sdk.execution.result")]
        ...
        [McpServerTool(Name = "sdk.execution.cancel")]
