...
namespace Multiplexed.AI.Runtime.Execution.Payloads.Serialization
{
    /// <summary>
    /// Produces deterministic canonical JSON for immutable execution payloads.
    /// </summary>
    internal static class AiCanonicalJson
    {
        ...
        public static T Deserialize<T>(string json)
        {
            ...
            return JsonSerializer.Deserialize<T>(json, SerializerOptions)
                ?? throw new InvalidOperationException(
                    $"Canonical execution payload could not be deserialized as '{typeof(T).FullName}'.");
        }
