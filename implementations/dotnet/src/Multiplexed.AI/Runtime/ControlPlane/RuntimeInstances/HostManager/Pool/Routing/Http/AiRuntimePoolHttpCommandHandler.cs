...
{
    /// <summary>
    /// Routes stable HTTP pool commands to exact process-host runtime instances.
    /// </summary>
    public sealed class AiRuntimePoolHttpCommandHandler :
        IAiRuntimePoolHttpCommandHandler
    {
        ...
        private readonly IAiRuntimePoolHttpTransportForwarder
            transportForwarder;

        /// <summary>
        /// Initializes a new instance of the
        /// <see cref="AiRuntimePoolHttpCommandHandler"/> class.
        /// </summary>
        public AiRuntimePoolHttpCommandHandler(
            IAiRuntimeProcessPoolManager poolManager,
            IAiRuntimePoolRouteForwarder routeForwarder,
            IAiRuntimePoolHttpTransportForwarder transportForwarder)
        {
            this.poolManager =
                poolManager
            ...
            CancellationToken cancellationToken = default)
        {
                    ...
                    targetRuntimeInstanceId))
            {
                return CreateFailure(
                    ...
                    "The Runtime Pool HTTP command requires an exact RuntimeInstanceId.",
                    routeStatus: null,
                    exception: null);
            }
            ...
            var failureReason =
                status switch
                {
                    AiRuntimePoolRouteResolutionStatus.NotFound =>
                        AiRuntimePoolHttpRoutingFailureReasons.RouteNotFound,
                    AiRuntimePoolRouteResolutionStatus.PoolMismatch =>
                        AiRuntimePoolHttpRoutingFailureReasons.PoolMismatch,
                    AiRuntimePoolRouteResolutionStatus.HostMismatch =>
                        AiRuntimePoolHttpRoutingFailureReasons.HostMismatch,
                    AiRuntimePoolRouteResolutionStatus.TransportMismatch =>
                        AiRuntimePoolHttpRoutingFailureReasons
                            .TransportMismatch,
                    AiRuntimePoolRouteResolutionStatus.Draining =>
                        AiRuntimePoolHttpRoutingFailureReasons.RouteDraining,
                    _ =>
                        AiRuntimePoolHttpRoutingFailureReasons
                            .ForwardingFailed
                };
