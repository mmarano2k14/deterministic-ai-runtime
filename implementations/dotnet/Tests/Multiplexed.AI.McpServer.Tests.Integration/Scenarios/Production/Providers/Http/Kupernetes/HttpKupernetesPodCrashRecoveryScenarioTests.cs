...
namespace Multiplexed.AI.McpServer.Tests.Integration.Scenarios.Production.Providers.Http.Kubernetes
{
    ...
    /// </summary>
    public sealed class HttpKubernetesPodCrashRecoveryScenarioStabilityLoopTests
        : ProcessHostRealRuntimeCrashRecoveryScenarioTestsBase
    {
        ...
        public HttpKubernetesPodCrashRecoveryScenarioStabilityLoopTests(
            ITestOutputHelper output)
            : base(
                output,
                new HttpKubernetesSdkPodCrashRecoveryScenarioRuntimeProfile())
        {
            this.output = output
        ...
        [Fact]
        public Task Http_KubernetesSdk_Should_Requeue_Real_InFlight_Dag_After_Runtime_Pod_Kill()
        {
        ...
        /// <returns>A task that completes when the proof has finished.</returns>
        [Fact]
        public Task Http_KubernetesSdk_Should_Recover_Two_Tenants_After_Real_Runtime_Process_Kills_With_Strict_Dag_Resume_Replay_Ledger_And_Trace()
        {
        ...
        /// <returns>A task that completes when the proof has finished.</returns>
        [Fact]
        public Task Http_KubernetesSdk_Should_Recover_Two_Tenants_After_Real_Runtime_Process_Kills_Without_Impacting_Safe_Tenant_With_Strict_Dag_Resume_Replay_Ledger_And_Trace()
        {
        ...
        [Fact]
        public async Task Http_KubernetesSdk_Should_Requeue_Real_InFlight_Dag_After_Runtime_Pod_Kill_Stability_10x()
        {
            var failures =
                new List<string>();
        ...
        [Theory]
        [InlineData(10)]
        public async Task Http_KubernetesSdk_Should_Execute_MultiTenant_Pod_Crash_Recovery_Scenarios_In_Parallel_Loop(
            int parallelism)
        {
