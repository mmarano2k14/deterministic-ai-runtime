...
{
    /// <summary>
    /// Builds MCP host settings for production HTTP Kubernetes SDK host-manager scenarios.
    /// </summary>
    /// <remarks>
    ...
    ///
    /// HTTP remains the runtime provider and command transport.
    ...
    /// </remarks>
    internal static class HttpKubernetesSdkHostProductionScenarioSettingsBuilder
    {
        /// <summary>
        /// Builds the complete settings dictionary for a production HTTP Kubernetes SDK host-manager scenario.
        /// </summary>
            ...
            string runtimeHostAssemblyPath)
        {
            ...
            var settings =
                HttpKubernetesHostProductionScenarioSettingsBuilder.Build(
                    scenario,
                    controlPlaneId,
