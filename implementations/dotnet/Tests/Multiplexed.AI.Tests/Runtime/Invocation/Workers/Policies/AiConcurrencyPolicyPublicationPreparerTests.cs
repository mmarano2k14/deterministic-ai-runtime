...
namespace Multiplexed.AI.Tests.Runtime.Invocation.Workers.Policies
{
    ...
    public sealed class AiConcurrencyPolicyPublicationPreparerTests
    {
        [Theory]
        [InlineData("python")]
        ...
        private static AiConcurrencyPolicyPublicationPreparer CreatePreparer(PublicationTestSupport.Fixture fixture) => new(
            fixture.Store,
            fixture.Accessor,
        ...
        private static AiConcurrencyPolicyRequest Request(
            string executionId,
            ...
            int copies = 1)
        {
            ...
            {
                ["concurrency"] = new AiConcurrencyDefinition { Policies = policies }
            };
            ...
            var functions = Enumerable.Range(0, copies).Select(index => new AiPublicationFunctionUpload(
                new AiPublicationCallSite(AiPublicationFunctionKind.ConcurrencyPolicy, stepScoped ? "native" : null, index),
                language + "-fixed",
                "policy.txt",
                "run",
