...
namespace Multiplexed.AI.Tests.Unit.ControlPlane.SharedController
{
    ...
    public sealed class AiSharedRuntimeControllerTenantScaleOutTests
    {
        ...
        /// </summary>
        private sealed class NoopSharedQueue : IAiSharedQueue
        {
            /// <summary>
            ...
            public Task<AiSharedQueueItem?> RequeueDispatchedAsync(string sharedRunId, string claimToken, string? reason = null, CancellationToken cancellationToken = default)
            {
                cancellationToken.ThrowIfCancellationRequested();
