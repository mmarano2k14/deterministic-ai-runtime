...
| [`ai/child-dag-composition.md`](ai/child-dag-composition.md) | **Experimental** durable Child DAG composition, `WaitingForExternal`, deterministic continuation, nested recovery semantics, current Depth 1 production proof, and the engine-lifecycle observation gate required before broader production readiness. |
