...
| [`ai/multilanguage-runtime-matrix-validation.md`](ai/multilanguage-runtime-matrix-validation.md) | Fixture-free 33/33 Docker ProcessHostPool closure across all three external SDK clients and production hosted workers, including pinning, dependency packaging, policies, nested Child DAGs, MCP effects, cancellation, recovery, journal acceptance, and SDK dependency firewalls. |
...
| [`ai/multilanguage-runtime-matrix-validation.md`](ai/multilanguage-runtime-matrix-validation.md) | Fixture-free 33/33 Docker ProcessHostPool validation across external SDK clients, production hosted workers, pinning, dependency packaging, policies, nested Child DAGs, MCP effects, cancellation, recovery, journal acceptance, and dependency firewalls. |
