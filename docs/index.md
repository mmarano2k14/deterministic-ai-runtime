...
| [`ai/external-sdk-libraries-validation.md`](ai/external-sdk-libraries-validation.md) | Shared cross-language parity and local package build/install/import evidence. |
